...
# BibTex meta-data, to be used in the PDF output (optional)
...
# Index file(s) containing the Markdown sources
...
ebook_dir="${ebook_dir:-"$build_dir/ebook"}"
single_md="${single_md:-"$build_dir/doc.md"}"
single_pdf="${single_pdf:-"$pdf_dir/doc.pdf"}"
single_epub="${single_epub:-"$ebook_dir/doc.epub"}"
